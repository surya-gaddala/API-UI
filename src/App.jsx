        ...
        <Box sx={{ 
          ...
          <Paper
            ...
            sx={{ 
              ...
              borderRadius: 1,
              transition: theme => 
                `border-color ${theme.transitions.duration.standard}ms ${theme.transitions.easing.easeInOut}, box-shadow ${theme.transitions.duration.shorter}ms ${theme.transitions.easing.easeInOut}`,
              '&:hover': {
            ...
            sx={{
              ...
              transition: theme => 
                `width ${theme.transitions.duration.standard}ms ${theme.transitions.easing.easeInOut},
                 border-color ${theme.transitions.duration.standard}ms ${theme.transitions.easing.easeInOut}`,
              '&:hover': {
                boxShadow: '0 0 10px 0 rgba(0,0,0,0.05)'
              }
            }}
